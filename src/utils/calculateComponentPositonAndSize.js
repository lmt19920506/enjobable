...
function calculateTop(style, curPosition, proportion, needLockProportion, pointInfo) {
  ...
  if (newHeight > 0) {
    ...
    style.width = width;
    style.height = Math.round(newHeight);
    style.y = Math.round(newCenterPoint.y - newHeight / 2);
    style.x = Math.round(newCenterPoint.x - width / 2);
  }
}
...
function calculateRight(style, curPosition, proportion, needLockProportion, pointInfo) {
  ...
  if (newWidth > 0) {
    ...
    style.height = height;
    style.width = Math.round(newWidth);
    style.y = Math.round(newCenterPoint.y - height / 2);
    style.x = Math.round(newCenterPoint.x - newWidth / 2);
  }
}
